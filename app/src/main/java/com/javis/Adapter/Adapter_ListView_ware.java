...
public class Adapter_ListView_ware extends BaseAdapter {
	...
	public View getView(int position, View currentView, ViewGroup arg2) {
		...
		if (arrayList.size() != 0) {
			...
			holderView.tv_price.setText("xiayy" + arrayList.get(position).get("price").toString() + "Ԫ");
			holderView.tv_sale_num.setText("xiayy:" + arrayList.get(position).get("sale_num").toString() + "xiayy     " + arrayList.get(position).get("address").toString());
		}
		return currentView;
	}
